-- Fix Clerk User ID type mismatch - First drop all dependent policies

-- Drop all policies that depend on presentations_generated.user_id
DROP POLICY IF EXISTS "presentations_select" ON public.presentations_generated;
DROP POLICY IF EXISTS "presentations_insert" ON public.presentations_generated;
DROP POLICY IF EXISTS "presentations_update" ON public.presentations_generated;
DROP POLICY IF EXISTS "presentations_delete" ON public.presentations_generated;
...
-- Drop all policies that depend on blueprints.user_id
...
-- Drop policies that reference presentations_generated through joins
DROP POLICY IF EXISTS "presentation_plans_select" ON public.presentation_plans;
DROP POLICY IF EXISTS "presentation_plans_insert" ON public.presentation_plans;
DROP POLICY IF EXISTS "presentation_plans_update" ON public.presentation_plans;
DROP POLICY IF EXISTS "presentation_plans_delete" ON public.presentation_plans;
...
DROP POLICY IF EXISTS "slide_generations_select" ON public.slide_generations;
DROP POLICY IF EXISTS "slide_generations_insert" ON public.slide_generations;
DROP POLICY IF EXISTS "slide_generations_update" ON public.slide_generations;
DROP POLICY IF EXISTS "slide_generations_delete" ON public.slide_generations;
...
-- Recreate all the policies with text comparisons
