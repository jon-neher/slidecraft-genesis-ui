...
const ModernHero = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-ice-white my-[28px] py-0">
      {/* Background gradient */}
      <div className="inset-0 hero-gradient py-0" />
